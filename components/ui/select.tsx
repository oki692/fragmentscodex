...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex items-center gap-2 text-sm font-medium text-gray-800 dark:text-gray-200 focus:outline-none whitespace-nowrap overflow-hidden",
      className
    )}
    {...props}
  >
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(s.MenuList, className)}
      position={position}
      {...props}
    >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(s.MenuItem, s.RadioItem, className)}
    {...props}
  >
